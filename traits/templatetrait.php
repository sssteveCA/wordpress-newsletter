    ...
    public static function mailTemplateMessages(string $lang, array $params): array{
        ...
        if($lang == Langs::$langs["it"]){
            return [
                ...
                'privacy_policy_page' => '<div style="margin-top: 10px;">Puoi consultare <a href="'.$settings['privacy_policy_pages'][$lang].'" target="_blank" title="Privacy">qui</a> la nostra informativa sulla privacy.',
                'contacts_page' => 'Per ulteriori informazioni sui tuoi dati personali, contattaci a questo <a href="'.$settings['contact_pages'][$lang].'" target="_blank" title="Contattaci">link</a></div>',
            ...
            return [
                ...
                'privacy_policy_page' => '<div style="margin-top: 10px;">Puede consultar nuestra política de privacidad <a href="'.$settings['privacy_policy_pages'][$lang].'" target="_blank" title="Privacidad">aquí</a>.',
                'contacts_page' => 'Para obtener más información sobre sus datos personales, contáctenos en este <a href="'.$settings['contact_pages'][$lang].'" target="_blank" title="Contáctenos">enlace</a></div>',
            ...
            return [
                ...
                'privacy_policy_page' => '<div style="margin-top: 10px;">You can consult our privacy policy <a href="'.$settings['privacy_policy_pages'][$lang].'" target="_blank" title="Privacy">here</a>.',
                'contacts_page' => 'For more information on your personal data, contact us at this <a href="'.$settings['contact_pages'][$lang].'" target="_blank" title="Contact us">link</a></div>',
