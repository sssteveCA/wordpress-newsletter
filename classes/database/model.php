...
SQL;
        file_put_contents("log.txt","Model get sql => ".var_export($sql,true)."\r\n",FILE_APPEND);
        file_put_contents("log.txt","Model get query param => ".var_export($query,true)."\r\n",FILE_APPEND);
        file_put_contents("log.txt","Model get values => ".var_export($values,true)."\r\n",FILE_APPEND);
        $this->query = $this->wpdb->prepare($sql,$values);
